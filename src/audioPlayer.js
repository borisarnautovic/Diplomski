...
class AudioPlayer {
    ...
    createPlayListElements(playListElem) {
        ...
        this.currentAudio = this.audioElements[1];
    }
...
const player = new AudioPlayer('.audioPlayer', [
    { name: 'Kazka', url: 'public/KAZKA.mp3' },
    { name: 'El_Comandante', url: 'public/El_Comandante.mp3' },
    { name: 'Mombassa', url: 'public/Mombassa.mp3' },
    { name: 'Morandi', url: 'public/Morandi.mp3' },
]);
...
ws.addEventListener("message", ({ data }) => {
    ...
    changingVolume(JSON.parse(data));
});
